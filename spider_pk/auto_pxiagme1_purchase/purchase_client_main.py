...
from auto_pxiagme1_purchase.models import ProbUser
from auto_pxiagme1_purchase.client_thread  import ThreadControl
from auto_pxiagme1_purchase.driver import get_driver
...
def control_probuser_thread(request):
    ...
    return render_to_response('pxiagme1_purchase_main.html',{"prob_user_list":prob_user_list, "p_rule":request.POST['in_rule'], "p_monery":money,
...
def auto_admin(request):
    ...
    for prob_user in prob_user_list:
        ...
        try:
            ...
            prob_user.user_status = 0
            prob_user.save()
    return render_to_response('pxiagme1_purchase_main.html',{"prob_user_list":prob_user_list})
...
#根据预测list转换成要购买的元素
def get_pxiagme1_xiazhu_message(purchase_number_str):
    buy_element_list = []
...
def get_pxiagme1_xiazhu_message_trans(purchase_number_str):
    buy_element_list = []
    # purchase_number_str = '0,9|2|4|7,9|2|10|6,3|4|5|6|7|9,8|1|2|10,1|2|5|7|8|9,1|3|6|8|9|10'
