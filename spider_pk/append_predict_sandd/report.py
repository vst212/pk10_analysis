...
from append_predict_sandd.models import KillPredictTotal
...
from append_predict_sandd.main import calculate_percisoin


from pkten_log.pk_log import PkLog

pk_logger = PkLog('append_predict_sandd.report').log()
...
def predict_report(request):
    ...
    return render_to_response('append_predict_sandd_list.html',{"obj_pro_predict":obj_pro_predict})
...
def control_predict_report(request):
    ...
    return render_to_response('append_predict_sandd_list.html',{"obj_pro_predict":obj_pro_predict, "obj_pro_predict_total":obj_pro_predict_total,  "p_date":in_date})
